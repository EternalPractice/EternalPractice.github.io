let specializationData = [
  ...
  },
  {
    ...
    perks: [
      ...
      },
      {
        ...
        details: `An adventurer can rally their allies to travel more efficiently.</br>
      When making a successful <em>Persuasion</em> check during the trip planning stage, you can remove an hour of travel per day equal to the degree of success.`
      },
      {
        level: 2,
        type: "Exploration",
        name: '"This group is with me"',
        AP: 20,
        requirements: {
          strength: 1,
          perception: 2,
        ...
        details: `An adventurer can get a bulk discount when purchasing goods/services that can be shared (like a room in an inn)</br>
     When making a successful <em>Persuasion</em> check to purchase a sharable good/service, the adventurer can include for free a number of allies equal to the degree of success.`
      },
      {
        level: 3,
        type: "Exploration",
        ...
        details: `An adventurer can aid an ally in working through a task that they are familiar with.</br>
    When making a successful <em>Persuasion</em> check while an ally is utilizing a skill that the adventurer has ranks in, they can add their degree of success to the allie's roll.`
      },
      {
        level: 4,
        type: "Exploration",
        name: "Talk through task",
        AP: 20,
        requirements: {
          strength: 1,
          perception: 4,
        ...
        details: `An adventurer can use their words alone to talk another person through a task they are familiar with.</br>
    When making a successful <em>Persuasion</em> check, the adventurer can explain a skill to an ally in a way that they understand completely.</br>
    The ally can then use the skill with the adventurer's goal with a bonus equal to the degree of success on the <em>Persuasion</em> check.`
      },
      {
        level: 5,
        type: "Exploration",
        ...
        details: `An adventurer can aid an ally with a task so skillfully that they have increased performance.</br>
        After making a successful <em>persuasion</em> check, an ally can take a number of retries to a skill check equal to the degree of success.</br>
        (A retry in this case will allow the ally to ignore a bad skill check and not use any AP.)`
      },
      {
        level: 1,
        type: "Interaction",
        name: "Respectable Presence",
        AP: 0,
        requirements: {
          strength: 1,
          perception: 1,
        ...
        details: `An adventurer with this perk lives in such a way that others trust his/her word.</br>
      When talking to a person that has not been lied to, the adventurer gains a +2 bonus to all <em>persuasion</em> checks.`
      },
      {
        level: 2,
        type: "Interaction",
        ...
        details: `An adventurer with this perk can request the aid of other beings more easily than others can.</br>
      When making a <em>persuasion</em> check, the adventurer can reduce any circumstantial penalty by 2.</br>
      (In other words, if there would be a penalty of -4 to the goal roll, it becomes a -2 instead.)`
      },
      {
        level: 3,
        type: "Interaction",
        name: "Vouge for Others",
        AP: 20,
        requirements: {
          strength: 1,
          perception: 3,
        ...
        details: `An adventurer can give his/her word for allies, granting them a bonus when interacting with others.</br>
      After making a successful <em>persuasion</em> check, an ally that was vouged for will gain a bonus to charisma checks equal to the degree of succes.`
      },
      {
        level: 4,
        type: "Interaction",
        ...
        details: `An adventurer can command another being to perform an action that they are capable of doing.</br>
      After making a successful <em>persuasion</em> check, a being is compelled to perform an action that can be completed within as many hours as the degree of success.</br>
      (Depending on the request, there might be a penalty to the goal.)`
      },
      {
        level: 5,
        type: "Interaction",
        ...
        details: `An adventurer is so convincing that their very word carries weight.</br>
      After making a successful <em>persuasion</em> roll, the policy that is being said is taken as law.</br>
      (Needs work)`
      }
    ]
  },
  ...
  {
    name: "Parkour",
    description: `Parkour is some stuff.`,
    perks: [
      {
        level: 0,
        type: "Exploration",
